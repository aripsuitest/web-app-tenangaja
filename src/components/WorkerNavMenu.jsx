    ...
    <>
      {user ? (
        <div className="order-1 ml-auto flex items-center space-x-5 relative">
            ...
            {showNotifications && (
              <div className="absolute right-0 top-0 mt-6 bg-white shadow-lg rounded-lg w-80 max-h-96 overflow-y-auto z-50">
                <div className="p-3 border-b flex justify-between items-center">
                  <h5 className="font-semibold text-gray-700 sticky top-0">Notifications</h5>
                  {unreadCount > 0 && (
                    <button 
          ...
          {showDropdown && (
              <div className="absolute right-0 top-0 mt-6 bg-white shadow-lg rounded-lg w-48 z-50">
                <div className="p-2">
        ...
        <div className="order-1 ml-auto hidden lg:flex items-center space-x-5">
